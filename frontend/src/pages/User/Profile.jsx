...
const Profile = () => {
  ...
  useEffect(() => {
    // Load fresh statistics (e.g. total bookings)
  ...
  // Update input values when user context loads/changes
  useEffect(() => {
    if (user) {
      setName(user.name || '');
  ...
  return (
    <div className="mx-auto max-w-5xl">
      <div className="mb-6">
        <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight font-display">My Account</h1>
        <p className="mt-1 text-sm text-gray-500">Configure your personal preferences, billing address, and security keys</p>
      </div>
        ...
        <div className="space-y-6 lg:col-span-1">
          <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-soft transition duration-300 hover:shadow-soft-md">
            <div className="flex flex-col items-center text-center">
              ...
              <span className="mt-3 inline-flex items-center gap-1.5 rounded-full bg-amber-50 px-3 py-1 text-xs font-semibold text-amber-700 border border-amber-200/50">
            ...
            <div className="mt-6 border-t border-slate-100 pt-6 grid grid-cols-2 gap-4 text-center">
              ...
              <div className="rounded-xl bg-slate-50/50 p-3 border border-slate-100">
                ...
                <div className="mt-1 flex items-center justify-center gap-1 text-xs font-bold text-slate-700 leading-normal pt-0.5">
                  <CalendarDays className="h-4 w-4 text-primary-500 shrink-0" />
                  {joinDate}
                </div>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {activeTab === 'personal' && (
                <div className="space-y-5 animate-fade-in">
                  ...
                  <p className="text-xs text-gray-400">Keep your details up-to-date to ease checking in at check-in counters.</p>
              ...
              {activeTab === 'address' && (
                <div className="space-y-5 animate-fade-in">
                  <h3 className="text-xl font-bold text-gray-900 font-display">Billing & Stay Address</h3>
                  <p className="text-xs text-gray-400">Your address is used for secure checkout receipt invoicing and local tax records.</p>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="123 Luxury Dr Suite 400"
                        className="w-full rounded-xl border border-slate-200 bg-slate-50/50 px-4 py-2.5 text-sm outline-none transition focus:border-primary-500 focus:bg-white focus:ring-2 focus:ring-primary-500/20"
                      />
                    </div>
              ...
              {activeTab === 'security' && (
                <div className="space-y-5 animate-fade-in">
                  <h3 className="text-xl font-bold text-gray-900 font-display">Security Settings</h3>
                  <p className="text-xs text-gray-400">Regularly updates keep your booking portal keys and payments secure.</p>
